...
@NgModule({
  imports: [RouterModule.forChild([
    ...
    {
      path: 'facturation-commandes',
      loadChildren: () =>
        import('../pages/facturation-commandes/facturation-commandes.module').then(m => m.FacturationCommandesModule),
      canActivate: [authGuard],
      data: { roles: ['OWNER'] }
    },
    {
      path: 'exportation-commandes',
      loadChildren: () =>
        import('../pages/exportation-commandes/exportation-commandes.module').then(m => m.ExportationCommandesModule),
      canActivate: [authGuard],
      data: { roles: ['OWNER'] }
    },
    {
