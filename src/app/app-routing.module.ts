...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'pages/import', loadChildren: () => import('./pages/import/import.module').then(m => m.ImportModule),       canActivate: [authGuard],
        data: { roles: ['OWNER'] } },
      {path: 'pages/empty', loadChildren: () => import('./pages/empty/emptydemo-routing.module').then(m => m.EmptyDemoRoutingModule),       canActivate: [authGuard],
        data: { roles: ['OWNER'] } },
      { path: 'pages/import-details/:id', loadChildren: () => import('./pages/import-details/import-details.module').then(m => m.ImportDetailsModule) ,       canActivate: [authGuard],
        data: { roles: ['OWNER'] }},
